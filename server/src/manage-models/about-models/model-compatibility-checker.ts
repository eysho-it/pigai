...
class ModelCompatibilityChecker {
    ...
    public static checkModelCompatibility({hardwareCompatibility, compatiblePigAIVersionRange}: Pick<ModelSettings, 'hardwareCompatibility' | 'compatiblePigAIVersionRange'>): Compatibility {
